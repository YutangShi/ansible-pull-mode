...
echo "*/5 * * * * /usr/bin/ansible-pull -U https://github.com/YutangShi/ansible-pull-mode.git --vault-password-file /opt/docker/ansible-pull-mode/vault_password.txt >> /log/ansible-pull.log 2>&1" >> /etc/crontab.d/ansible-cron
